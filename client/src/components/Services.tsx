  ...
  const services = [
    {
      ...
      description: 'We create responsive, modern websites that deliver exceptional user experiences across all devices.',
      icon: (
    ...
    },
    {
      ...
      description: 'We build custom Shopify stores that are optimized for conversions and seamless customer experiences.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" viewBox="0 0 20 20" fill="currentColor">
    ...
    },
    {
      ...
      description: 'We design and develop custom Shopify themes tailored to your brand\'s unique identity and requirements.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" viewBox="0 0 20 20" fill="currentColor">
